...
export function TankForm({ tank, mode = "auto" }: { tank: Tank | null; mode?: "auto" | "create" | "edit" }) {
  ...
  return (
    <Card className="shadow-lg shadow-primary/5">
      ...
      <CardContent>
        <form action={upsertTank} className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="space-y-1">
            ...
            <Input id="water_change_percent" name="water_change_percent" type="number" step="0.1" defaultValue={tank?.water_change_percent ?? 10} />
          </div>
          <div className="space-y-1">
            <Label htmlFor="water_change_interval_days">Every (days)</Label>
            <Input id="water_change_interval_days" name="water_change_interval_days" type="number" defaultValue={tank?.water_change_interval_days ?? 7} />
          </div>
          <div className="space-y-1 sm:col-span-2">
